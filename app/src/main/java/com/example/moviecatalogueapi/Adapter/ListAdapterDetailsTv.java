...
public class ListAdapterDetailsTv extends RecyclerView.Adapter<ListAdapterDetailsTv.ListViewHolder> {

    private ArrayList<ListDetailsTv> listData = new ArrayList<>();

    public void setData(ArrayList<ListDetailsTv> items) {
        listData.clear();
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_details_tv, viewGroup, false);
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView poster;
        TextView title, description, releaseDate, runtime, ratingValue, productionCompanies, genres;
        RatingBar ratingBar;
        Button watch;
